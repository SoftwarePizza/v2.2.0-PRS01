...
<<<<<<< HEAD:modules/ttbrandlogo/views/templates/hook/ttbrandlogo.tpl
...
{/foreach}
 ...
 <section class="brands container">
	<h2 class="h1 products-section-title text-uppercase tt-title">
	...
	<div class="customNavigation">
		<div class="btn-prev">
		<a class="btn prev ttbrandlogo_prev"></a>
		</div>
	    <div class="btn-next">
		<a class="btn next ttbrandlogo_next"></a>
		</div>
	</div>
	{/if}  
	<div class="products">
...
>>>>>>> master:dependencies/modules/ttbrandlogo/views/templates/hook/ttbrandlogo.tpl
	{if $brands}
