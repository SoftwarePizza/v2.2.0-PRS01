			...
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						...
						<img src="{$image_baseurl|escape:'html':'UTF-8'}{$fields[0]['form']['images'][$language.id_lang]|escape:'html':'UTF-8'}" class="img-thumbnail" loading="lazy" />
						{/if}
						<div class="dummyfile input-group">
							...
							<span class="input-group-btn">
								<button id="{$input.name|escape:'html':'UTF-8'}_{$language.id_lang|intval}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> {l s='Choose a file' mod='ttproductpopup'}
								</button>
							</span>
						</div>
					</div>
