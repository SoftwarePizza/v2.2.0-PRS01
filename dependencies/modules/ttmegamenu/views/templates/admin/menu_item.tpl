	...
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group tt-fw-icon" {if $menu->type_icon == 0}style="display:none"{/if}>
			...
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Material Icons at :' mod='ttmegamenu'} <a href="https://material.io/tools/icons/?style=baseline" target="_blank">https://material.io/tools/icons/?style=baseline.</a> ex: icon-sun</p>
			</div>
		</div>
