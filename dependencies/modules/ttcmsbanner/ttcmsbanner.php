...
class TtCmsbanner extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('TT - CMS Banner block');
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="ttbanner1 ttbanner col-sm-4"><a href="#"><img alt="banner-02" src="../img/cms/banner-01.jpg" width="380" height="380" /></a><div class="ttbanner-text"><h2>POTTERY ART</h2><p>Get Save 35% OFF</p></div></div><div class="ttbanner2 ttbanner col-sm-8"><a href="#"> <img alt="banner-01" src="../img/cms/banner-02.jpg" width="780" height="380" /></a><div class="ttbanner-text col-sm-6 col-md-5"><h2>COMFORT+ CHAIRS</h2><h4>SALE On This Weekend</h4><button class="btn-primary">Shop Now</button></div></div>'
            ),
        );
