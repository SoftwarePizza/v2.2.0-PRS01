...
{block name="field"}
    {if $input.type == 'filemanager_image'}
        <div class="col-lg-4">
            ...
            <img class="img-responsive img-thumbnail layout_image hidden" src="{if isset($fields_value[$input.name])}{$fields_value[$input.name]|escape:'htmlall':'UTF-8'}{/if}" loading="lazy" >
        </div>
    {else}
        {$smarty.block.parent}
    {/if}
